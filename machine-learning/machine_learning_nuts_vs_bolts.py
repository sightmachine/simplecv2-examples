...
from simplecv.api import ImageSet, Blob
from simplecv.base import download_and_extract
...
bolt_blobs = [b.find(Blob)[0] for b in bolts]  # exact the blobs for our features
...
unnut_blobs = [n.invert().find(Blob)[0] for n in untrained_nuts]
